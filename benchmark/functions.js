Measure.module('Functions');

/**
 * test 1
 */

Measure.suit('Define object using prototype and initialize it.', function (start, stop) {
...
Measure.suit('Define object without using prototype and initialize it.', function (start, stop) {
    // make some preparation before tests
