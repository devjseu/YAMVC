...
//});
//
//Measure.suit('Searching in html using TreeWalker', function (start, stop, loops) {
//    var container = document.querySelector('#container'),
//        divs = [],
//        text;
//    // create dom elements
...
//
//    start();
//    text = customRecursive(container);
//    text = null;
//    stop();
//
//    loops(100);
...
Measure.suit('Evaluating DOM using functions', function (start, stop, loops) {
            ...
            for (var i = 0, l = arguments.length; i < l; i++) {
                ...
                if (arguments[i] instanceof Array) {
                    ...
                    for (var j = 0, l2 = arg.length; j < l2; j++) {
                        ...
                        el.attributes.setNamedItem(arg[j]);
...
Measure.suit('Evaluating DOM using string (innerHTML and string concatenation)', function (start, stop, loops) {
        ...
        for (var i = 0, l = 1000; i < l; i++) {
            ...
            e.innerHTML = '<div>' +
                '<p>Test</p><p>Taki test</p><p>Test</p><p>Taki test</p><p>Test</p><p>Taki test</p>' +
                '<p>Test</p><p>Taki test</p><p>Test</p><p>Taki test</p><p>Test</p><p>Taki test</p>' +
                '<p>Test</p><p>Taki test</p><p>Test</p><p>Taki test</p><p>Test</p><p>Taki test</p>' +
                '<p>Test</p><p>Taki test</p><p>Test</p><p>Taki test</p><p>Test</p><p>Taki test</p>' +
                '<p>Test</p><p>Taki test</p><p>Test</p><p>Taki test</p><p>Test</p><p>Taki test</p>' +
...
Measure.suit('Evaluating DOM using string (innerHTML and array join)', function (start, stop, loops) {
