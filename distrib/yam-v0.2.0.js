...
ya.$set('ya', 'Core', (function () {
    ...
    /**
     @method initDefaults
     */
    Core.prototype.makeConfig = function (opts) {
        return this;
    };
    ...
    /**
     ...
     @abstract
     */
    Core.prototype.checkRequired = function () {
        return this;
    };
...
ya.Core.$extend({
    ...
    doit: function () {
        ...
        {terminate: function (code, msg, stack) {
    ...
    initBus: function () {
        ...
        for (var connection in bus) {
            ...
            if (bus.hasOwnProperty(connection)) {
                ...
                left.obj.addEventListener(event, right.obj[callback], right.obj);
...
ya.Core.$extend({
    ...
    prepareTextBindings: function (node) {
        var results = node.data.match(/\{\{(.*?)\}\}/gi),// we searching for mustached text inside it
            i, len, headers, header, binding = false, result;
